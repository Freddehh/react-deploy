...
function App() {
  ...
  const getMatchHistory = async () => {
    ...
    let statsObj = {
      ...
      kda: kda,
      fbKill: stats.firstBloodKill,
      fbAssist: stats.firstBloodAssist,
      level: stats.champLevel,
      goldEarned: stats.goldEarned,
      goldSpent: stats.goldSpent,
      fbInhib: stats.firstInhibitorKill,
      longestAlive: stats.longestTimeSpentLiving,
      totalDmg: stats.totalDamageDealt,
      totalDmgChamp: stats.totalDamageDealtToChampions,
      amountOfCC: stats.timeCCingOthers,
      lengthOfCC: stats.totalTimeCrowdControlDealt,
      totalHeal: stats.totalHeal,
      doubleKills: stats.doubleKills,
      triple: stats.tripleKills,
      quadra: stats.quadraKills,
      penta: stats.pentaKills,
      sightWardsBought: stats.sightWardsBoughtInGame,
      killingSprees: stats.killingSprees,
      multiKill: stats.largestMultiKill,
  ...
  const getLeaderboards = async () => {
    const response = await fetch(
      "https://cors-anywhere.herokuapp.com/https://" +
        server +
        ".api.riotgames.com/lol/league-exp/v4/entries/RANKED_SOLO_5x5/CHALLENGER/I?page=1&api_key=" +
        api_key
    );
  ...
  const getFreeRotation = async (champMap) => {
    ...
    const response = await fetch(
      "https://cors-anywhere.herokuapp.com/https://" +
        server +
        ".api.riotgames.com/lol/platform/v3/champion-rotations?api_key=" +
        api_key
    );
        ...
        <Navbar bg="dark" variant="dark" expand="md">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              ...
              <Nav.Link href="https://eune.leagueoflegends.com/en-pl/">
                League of legends
              </Nav.Link>
              <Nav.Link href="https://developer.riotgames.com/apis">
                League API
              </Nav.Link>
            </Nav>
