...
function App() {
  ...
  const getMatchHistory = async () => {
    ...
    let statsObj = {
      kills: stats.kills, deaths: stats.deaths, assists: stats.assists, kda: kda, fbKill: stats.firstBloodKill, fbAssist: stats.firstBloodAssist, level: stats.champLevel,
  ...
  const getLeaderboards = async () => {
    const response = await fetch
      ("https://cors-anywhere.herokuapp.com/https://euw1.api.riotgames.com/lol/league-exp/v4/entries/RANKED_SOLO_5x5/CHALLENGER/I?page=1&api_key=" + api_key);
